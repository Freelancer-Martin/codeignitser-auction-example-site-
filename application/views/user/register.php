...
<div class="row" >
  <div style="margin-left: 8%;margin-right: 8%;" class="col-lg-10 col-lg-offset-2" >
...
*/
          ...
          ?>
          <a style="width: 100%; margin: 15px;" class="btn btn-lg btn-primary btn-block" href="<?php echo base_url(); ?>index.php/login">Login</a>
